...
Устанавливаем программу на windows. Для того чтобы установить программу, нам необходимо скачать файл exe для установки. Для разных операционных систем есть разные способы установки программ. Нам необходимо дождаться полной загрузки системы. (рис. [-@fig:001] ) 
...
Программа установлена и на работает на компьютере. Используя TeXworks мы можем работать с документами. Установка завершена. (рис. [-@fig:003] ) 
